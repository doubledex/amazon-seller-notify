...
class Order extends Model
{
    ...
    protected $casts = [
        'raw_order' => 'array',
        'dev_order_api_2026_response' => 'array',
        'dev_order_api_v0_response' => 'array',
        'is_business_order' => 'boolean',
        'is_marketplace_facilitator' => 'boolean',
        'purchase_date' => 'datetime',
        'purchase_date_local' => 'datetime',
        'purchase_date_local_date' => 'date',
        'dev_order_api_2026_fetched_at' => 'datetime',
        'dev_order_api_v0_fetched_at' => 'datetime',
        'amazon_fee_estimated_at' => 'datetime',
